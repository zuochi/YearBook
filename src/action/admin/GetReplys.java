...
public class GetReplys extends AdminAction{
	...
	public String execute() {
		...
		Integer replysCount = (Integer) service.getObjectByHql("select count(r.id) from Reply r where r.isDelete=0", "getInteger");
