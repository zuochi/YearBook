...
//显示添加学年
function showPro() {
	 document.getElementById("add_profession_div").style.display="block";
	 document.getElementById("add_profession_button1").style.display="none";
	 document.getElementById("add_profession_button2").style.display="block";
};

//隐藏添加学年
function hidePro() {
	 document.getElementById("add_profession_div").style.display="none";
	 document.getElementById("add_profession_button2").style.display="none";
	 document.getElementById("add_profession_button1").style.display="block";
};