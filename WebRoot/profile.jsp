...
<form class="border_radius" id="focus">
	...
	<label><span>Hometown</span><input type="text" class="input_txt border_radius" name="user.homeTown" value="<s:property value="#session.user.homeTown"/>"/></label>
	<label><span>Telephone</span><input type="text" class="input_txt border_radius" name="user.telePhone" value="<s:property value="#session.user.telePhone"/>"/> </label>
	<label><span>QQ</span><input type="text" class="input_txt border_radius" id="user.qq" name="user.qq" value="<s:property value="#session.user.qq"/>"></label>
	<label><span>WeChat</span><input type="text" class="input_txt border_radius" id="user.weChat" name="user.weChat" value="<s:property value="#session.user.weChat"/>"></label>
	<label><span>Sign</span><input type="text" class="input_txt border_radius" id="user.sign" name="user.sign" value="<s:property value="#session.user.sign"/>"></label>
	<h4>*必填</h4>
