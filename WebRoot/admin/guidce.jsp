...
<div id="" class="top"><a href="admin/Guanli_shouyegonggao.jsp" >首页公告</a></div>
<div id="getReplys" class="top"><a href="admin/getReplys_execute" >管理评论</a></div>
<div id="getPhotos" class="top"><a href="admin/getPhotos_execute">管理图片</a></div>
