				...
				<div class="prooo">
					<div class="rad">
                        ...
                        <s:else>
							...
							sign：<input type="text" id="signTextArea" style="display:none;	line-height:30px;" maxlength="68"/><input id="updateSignButton" style="display:none" type="button" value="Edit" onclick="updateSign()"/>
