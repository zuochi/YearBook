				...
				<div class="prooo">
					<div class="rad">
                        ...
                        <s:else>
							...
							sign：<input type="text" id="signTextArea" style="display:none; maxlength=68; height-line:22px;"/><input id="updateSignButton" style="display:none" type="button" value="Edit" onclick="updateSign()"/>
